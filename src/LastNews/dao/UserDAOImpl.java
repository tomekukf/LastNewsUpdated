...
public class UserDAOImpl implements UserDAO {
	...
	private static final String READ_USER_BY_USERNAME = "SELECT user_id, username, password, email, is_active FROM user WHERE username=:username";
	...
	public User create(User user) {
		...
		// Metoda zwraca nam klucz rekordu po dodaniu w bazie danych
